    ...
    return (
        <div className="box">
            ...
            <div className="bars-box">
                    ...
                    <DiscreteSliderSteps symbol = {"$"} min = {1000} max = {10000} name = {"Home Value"} currentVal = {homeval}  default = {3000} setVal = {setHomeVal} />


                    <DiscreteSliderSteps symbol = {"$"} min = {0} max = {homeval} name = {"Down Payment"} currentVal = {downval}  default = {downval} setVal = {setDownVal}/>


                    <DiscreteSliderSteps symbol = {"$"} min = {0} max = {homeval} name = {"Loan Amount"} currentVal = {loanval}  default = {loanval} setVal = {setLoanVal}/>


                    <DiscreteSliderSteps symbol = {"%"} min = {2} max = {18} name = {"Interest Rate"} currentVal = {interestval}  default = {interestval} setVal = {setInterestVal} step = {1}/>
